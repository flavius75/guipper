      ...
      return(
        <View style={{flex:1}}>
          <TouchableOpacity onPress={play} >
            ...
            <FontAwesome name={backgroundIcon} size={96} color="black" style={{position:"absolute",top:"5%",right:"10%",opacity:0.5}}/>
            <FontAwesome name={icon} size={98} color="white"  style={{position:"absolute",top:"5%",right:"10%",opacity:0.88}}/>
          </TouchableOpacity>
        </View>
      )
    }
